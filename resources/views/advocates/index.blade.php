<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex justify-center items-center float-right">
            ...
            <a href="{{ route('advocates.create') }}"
                class="inline-flex items-center ml-2 px-4 py-2 bg-blue-950 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-950 focus:bg-green-800 active:bg-green-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                </svg>
                <span class="hidden md:inline-block">Add Advocate</span>
            </a>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-4">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg" id="filters"
            style="display: none">
            <div class="p-6">
                <form method="GET" action="{{ route('advocates.index') }}">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <!-- Email Search -->
                        <div>
                            <x-input-filters name="email" label="Email" type="email" />
                        </div>
                        ...
                        <x-select-filter label="Bar Association" name="bar_association" filterKey="bar_association_id"
                            :options="$barAssociations->pluck('name', 'id')" placeholder="All Associations" />
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-2 pb-16">
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <table class="min-w-max w-full table-auto text-sm">
                    <thead>
                        <tr class="bg-green-800 text-white uppercase text-sm">
                            ...
                            <th class="py-2 px-2 text-left">Mobile</th>
                            <th class="py-2 px-2 text-left">Bar Association</th>
                    ...
                    <tbody class="text-black text-md leading-normal font-extrabold">
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-1 px-2 text-left text-gray-600 dark:text-gray-400">
                            ...
                            <td class="py-1 px-2 text-center">
                                <div class="flex justify-center space-x-2">
                                    ...
                                    <form action="{{ route('advocates.restore', $advocate->id) }}" method="POST"
                                        class="inline"
                                        onsubmit="return confirm('Are you sure you want to restore this advocate?');">
                                        @csrf
                                        @method('PATCH')
                                        <button type="submit"
            ...
            <p class="text-gray-700 dark:text-gray-300 text-center py-4">
                No advocates found.
                <a href="{{ route('advocates.create') }}" class="text-blue-600 hover:underline">
                    Create one now
                </a>.
            </p>
            @endif
