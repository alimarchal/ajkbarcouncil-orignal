        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('advocates.update', $advocate) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <select id="bar_association_id" name="bar_association_id"
                                ...
                                <option value="{{ $bar->id }}" {{ old('bar_association_id', $advocate->
                                    bar_association_id) == $bar->id ? 'selected' : '' }}>{{ $bar->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <x-input id="name" type="text" name="name" class="mt-1 block w-full"
                                    :value="old('name', $advocate->name)" required />
                            </div>
                            ...
                            <div>
                                ...
                                <x-input id="father_husband_name" type="text" name="father_husband_name"
                                    ...
                                    :value="old('father_husband_name', $advocate->father_husband_name)" required />
                            </div>
                            ...
                            <div>
                                ...
                                <x-input id="mobile_no" type="text" name="mobile_no" class="mt-1 block w-full"
                                    :value="old('mobile_no', $advocate->mobile_no)" required />
                            </div>
                            ...
                            <div>
                                ...
                                <x-input id="email_address" type="email" name="email_address" class="mt-1 block w-full"
                                    :value="old('email_address', $advocate->email_address)" required />
                            </div>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="complete_address" name="complete_address" rows="3"
                                class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                                required>{{ old('complete_address', $advocate->complete_address) }}</textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            ...
                            <div>
                                ...
                                <select id="is_active" name="is_active"
                                    ...
                                    <option value="1" {{ old('is_active', $advocate->is_active) == '1' ? 'selected' : ''
                                        }}>Active</option>
                                    <option value="0" {{ old('is_active', $advocate->is_active) == '0' ? 'selected' : ''
                                        }}>Inactive</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <x-input id="visitor_member_of_bar_association" type="text"
                                ...
                                :value="old('visitor_member_of_bar_association', $advocate->visitor_member_of_bar_association)" />
                        </div>
